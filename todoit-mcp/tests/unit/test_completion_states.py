...
class TestClearCompletionStates:
    ...
    def test_clear_all_states(self, manager_with_states):
        ...
        assert item.completion_states == {"quality": True, "tested": False, "reviewed": True}
        
        # Clear all states
        updated_item = manager_with_states.clear_item_completion_states("test_list", "test_item")
    ...
    def test_clear_nonexistent_states(self, manager_with_states):
        ...
        updated_item = manager_with_states.clear_item_completion_states(
            "test_list", "test_item",
            state_keys=["nonexistent", "also_missing"]
        )
        
        # Original states should remain unchanged
        assert updated_item.completion_states == {"quality": True, "tested": False, "reviewed": True}
    ...
    def test_clear_states_history_recorded(self, manager_with_states):
        ...
        assert entry.old_value['completion_states'] == {"quality": True, "tested": False, "reviewed": True}
...
class TestCompletionStatesIntegration:
    ...
    def test_states_merged_during_status_update(self, manager_with_states):
        ...
        updated_item = manager_with_states.update_item_status(
            "test_list", "test_item",
            status="failed",
            completion_states={"error_logged": True, "tested": True}  # Override tested, add new
        )
