...
from interfaces.cli_modules.item_commands import item_status, item_add, item_next, item_tree
...
class TestFORCETagsItemCommands:
    ...
    def test_item_status_blocked_by_force_tags(self, runner):
        ...
        with patch('interfaces.cli_modules.item_commands.get_manager') as mock_get_manager:
            ...
            with patch('interfaces.cli_modules.item_commands._get_filter_tags') as mock_get_tags:
    ...
    def test_item_next_blocked_by_force_tags(self, runner):
        ...
        with patch('interfaces.cli_modules.item_commands.get_manager') as mock_get_manager:
            ...
            with patch('interfaces.cli_modules.item_commands._get_filter_tags') as mock_get_tags:
                ...
                result = runner.invoke(item_next, [
                    'test_list'
                ], obj={'db_path': 'test.db'})
    ...
    def test_item_tree_blocked_by_force_tags(self, runner):
        ...
        with patch('interfaces.cli_modules.item_commands.get_manager') as mock_get_manager:
            ...
            with patch('interfaces.cli_modules.item_commands._get_filter_tags') as mock_get_tags:
                ...
                result = runner.invoke(item_tree, [
                    'test_list'
                ], obj={'db_path': 'test.db'})
