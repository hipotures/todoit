...
from interfaces.mcp_server import init_manager, todo_create_list
...
class TestMCPCreateListWithTags:
    ...
    async def test_mcp_create_list_without_tags(self):
        ...
        with patch(
            "interfaces.mcp_server.init_manager", return_value=self.test_manager
        ):
            result = await todo_create_list(list_key="test-list", title="Test List")
    ...
    async def test_mcp_create_list_with_none_tags(self):
        ...
        with patch(
            ...
            result = await todo_create_list(
                list_key="test-list", title="Test List", tags=None
            )
    ...
    async def test_mcp_create_list_with_empty_tags(self):
        ...
        with patch(
            ...
            result = await todo_create_list(
                list_key="test-list", title="Test List", tags=[]
            )
    ...
    async def test_mcp_create_list_with_existing_tags(self):
        ...
        with patch(
            ...
            result = await todo_create_list(
                list_key="webapp", title="Web Application", tags=["frontend", "backend"]
            )
    ...
    async def test_mcp_create_list_with_nonexistent_tag(self):
        ...
        with patch(
            ...
            result = await todo_create_list(
                list_key="test-list", title="Test List", tags=["nonexistent"]
            )
    ...
    async def test_mcp_create_list_exception_handling(self):
        ...
        with patch("interfaces.mcp_server.init_manager", return_value=mock_manager):
            result = await todo_create_list(list_key="error-test", title="Error Test")
    ...
    async def test_mcp_create_list_case_insensitive_tags(self):
        ...
        with patch(
            ...
            result = await todo_create_list(
                list_key="test-list", title="Test List", tags=["FRONTEND"]  # Uppercase
            )
    ...
    async def test_mcp_create_list_return_format_unchanged(self):
        ...
        with patch(
            ...
            result = await todo_create_list(
                list_key="format-test", title="Format Test", tags=["test-tag"]
            )
