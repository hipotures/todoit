...
class TestArchiveValidation:
    ...
    def test_archive_completed_list_without_force(self, manager):
        ...
        test_list = manager.create_list("completed-test", "Completed Test", 
                                      items=["Task 1", "Task 2"])
    ...
    def test_archive_incomplete_list_without_force_fails(self, manager):
        ...
        # Create list with tasks
        test_list = manager.create_list("incomplete-test", "Incomplete Test", 
    ...
    def test_archive_incomplete_list_with_force_succeeds(self, manager):
        ...
        # Create list with tasks
        test_list = manager.create_list("force-test", "Force Test", 
                                      items=["Task 1", "Task 2"])
    ...
    def test_archive_mixed_status_list_without_force_fails(self, manager):
        ...
        # Create list with tasks
        test_list = manager.create_list("mixed-test", "Mixed Status Test", 
    ...
    def test_archive_mixed_status_list_with_force_succeeds(self, manager):
        ...
        # Create list with tasks
        test_list = manager.create_list("mixed-force-test", "Mixed Force Test", 
                                      items=["Task 1", "Task 2"])
    ...
    def test_force_parameter_defaults_to_false(self, manager):
        ...
        test_list = manager.create_list("default-force-test", "Default Force Test", 
                                      items=["Task 1"])
