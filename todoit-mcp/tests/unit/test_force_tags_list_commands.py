...
from interfaces.cli_modules.list_commands import list_show, list_delete, list_archive, list_unarchive
...
class TestFORCETagsListCommands:
    ...
    def test_list_show_blocked_by_force_tags(self, runner):
        ...
        with patch('interfaces.cli_modules.list_commands.get_manager') as mock_get_manager:
            ...
            with patch('interfaces.cli_modules.list_commands._get_filter_tags') as mock_get_tags:
                mock_get_tags.return_value = ['dev']  # FORCE_TAGS=dev
                
                result = runner.invoke(list_show, [
                    'test_list'
                ], obj={'db_path': 'test.db'})
    ...
    def test_list_delete_blocked_by_force_tags(self, runner):
        ...
        with patch('interfaces.cli_modules.list_commands.get_manager') as mock_get_manager:
            mock_manager = MagicMock()
            mock_manager.get_lists_by_tags.return_value = []  # No lists with required tags
            mock_get_manager.return_value = mock_manager
            
            with patch('interfaces.cli_modules.list_commands._get_filter_tags') as mock_get_tags:
                mock_get_tags.return_value = ['dev']
                
                result = runner.invoke(list_delete, [
                    'test_list', '--force'
                ], obj={'db_path': 'test.db'})
    ...
    def test_list_archive_blocked_by_force_tags(self, runner):
        ...
        with patch('interfaces.cli_modules.list_commands.get_manager') as mock_get_manager:
            ...
            with patch('interfaces.cli_modules.list_commands._get_filter_tags') as mock_get_tags:
                ...
                result = runner.invoke(list_archive, [
                    'test_list', '--force'
                ], obj={'db_path': 'test.db'})
    ...
    def test_list_unarchive_blocked_by_force_tags(self, runner):
        ...
        with patch('interfaces.cli_modules.list_commands.get_manager') as mock_get_manager:
            ...
            with patch('interfaces.cli_modules.list_commands._get_filter_tags') as mock_get_tags:
                ...
                result = runner.invoke(list_unarchive, [
                    'test_list'
                ], obj={'db_path': 'test.db'})
