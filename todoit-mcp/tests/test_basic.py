...
def test_todoit():
    ...
    try:
        ...
        console.print(f"✅ Created list: {list1.list_key} with {len(list1.items) if hasattr(list1, 'items') else 3} items")
        ...
        console.print(f"✅ Set multi-state completion: {multi_state_item.completion_states}")
        ...
        console.print(f"✅ Progress: {progress.completed}/{progress.total} ({progress.completion_percentage:.1f}%)")
