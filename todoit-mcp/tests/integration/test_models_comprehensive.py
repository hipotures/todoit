...
from core.models import (
    ...
    ListRelation, ListRelationCreate,
    ItemDependency, ItemDependencyCreate,
    ListProperty, ListPropertyCreate,
    TodoHistory, TodoHistoryCreate,
    ProgressStats, CompletionStates,
    BulkOperationResult, DependencyGraph, BlockedItemsResult,
    ListType, ItemStatus, RelationType, HistoryAction, DependencyType
)
...
class TestModelsComprehensive:
    ...
    def test_todo_item_model(self):
        ...
        assert dict_repr["completion_states"] == {"designed": True, "implemented": False}
