...
class TestListDeletionFix:
    ...
    def test_delete_list_with_complex_structure(self, temp_manager):
        ...
        temp_manager.set_item_property("complex_list", "parent_item", "priority", "high")
        ...
        temp_manager.update_item_status("complex_list", "parent_item", status="in_progress")
        temp_manager.update_item_content("complex_list", "subtask1", "Updated subtask content")
    ...
    def test_bulk_list_deletion_no_foreign_key_errors(self, temp_manager):
        ...
        for i in range(3):
            ...
            for j in range(2):
                ...
                temp_manager.set_item_property(list_key, item_key, "priority", f"level_{j}")
                temp_manager.set_item_property(list_key, item_key, "category", f"cat_{i}")
