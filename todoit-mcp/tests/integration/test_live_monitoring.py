...
class TestLiveMonitoring:
    ...
    def test_get_list_hash_for_change_detection(self, temp_manager, sample_list_with_items):
    ...
    def test_change_detection_on_item_status_update(self, temp_manager, sample_list_with_items):
        """Test that status changes are detected"""
        def get_items_snapshot():
            items = temp_manager.get_list_items("live_test")
            return [(item.item_key, item.status, str(item.updated_at)) for item in items]
    ...
    def test_change_detection_on_item_content_edit(self, temp_manager, sample_list_with_items):
        """Test that content changes are detected"""
        def get_items_snapshot():
            items = temp_manager.get_list_items("live_test")
            return [(item.item_key, item.content, str(item.updated_at)) for item in items]
    ...
    def test_change_detection_on_item_deletion(self, temp_manager, sample_list_with_items):
    ...
    def test_change_detection_on_new_item_addition(self, temp_manager, sample_list_with_items):
    ...
    def test_progress_tracking_for_live_display(self, temp_manager, sample_list_with_items):
    ...
    def test_filtered_status_view(self, temp_manager, sample_list_with_items):
        ...
        in_progress_items = temp_manager.get_list_items("live_test", status="in_progress")
