...
class TestItemManagement:
    ...
    def sample_list_and_item(self, temp_manager):
        ...
        # Create item
        test_item = temp_manager.add_item("test_list", "test_item", "Original test content")
    ...
    def test_delete_item_with_subtasks(self, temp_manager, sample_list_and_item):
        ...
        # Add subtasks
        subtask1 = temp_manager.add_subtask("test_list", "test_item", "sub1", "Subtask 1")
        subtask2 = temp_manager.add_subtask("test_list", "test_item", "sub2", "Subtask 2")
    ...
    def test_update_item_content_success(self, temp_manager, sample_list_and_item):
        ...
        updated_item = temp_manager.update_item_content("test_list", "test_item", new_content)
    ...
    def test_update_item_content_nonexistent_item(self, temp_manager, sample_list_and_item):
    ...
    def test_update_item_content_empty_content(self, temp_manager, sample_list_and_item):
    ...
    def test_update_item_content_history_tracking(self, temp_manager, sample_list_and_item):
        """Test that content updates are tracked in history"""
        test_list, test_item = sample_list_and_item
        
        # Update content
        temp_manager.update_item_content("test_list", "test_item", "New content for history test")
    ...
    def test_mcp_delete_item_not_found(self, temp_manager, sample_list_and_item):
        ...
        with patch('interfaces.mcp_server.init_manager', return_value=temp_manager):
            import asyncio
            result = asyncio.run(mcp_server.todo_delete_item("test_list", "nonexistent"))
    ...
    def test_mcp_update_content_success(self, temp_manager, sample_list_and_item):
        ...
        with patch('interfaces.mcp_server.init_manager', return_value=temp_manager):
            import asyncio
            result = asyncio.run(mcp_server.todo_update_item_content("test_list", "test_item", new_content))
    ...
    def test_mcp_update_content_error_handling(self, temp_manager):
        ...
        with patch('interfaces.mcp_server.init_manager', return_value=temp_manager):
            import asyncio
            result = asyncio.run(mcp_server.todo_update_item_content("nonexistent", "item", "content"))
    ...
    def test_delete_and_recreate_item(self, temp_manager, sample_list_and_item):
        ...
        new_item = temp_manager.add_item("test_list", "test_item", "Recreated item content")
        
        # Verify it's a new item
        assert new_item.content == "Recreated item content"
        assert new_item.item_key == "test_item"

    def test_content_update_preserves_other_fields(self, temp_manager, sample_list_and_item):
    ...
    def test_bulk_operations_compatibility(self, temp_manager):
        ...
        for i in range(3):
            temp_manager.update_item_content("bulk_test", f"item_{i}", f"Updated content {i}")
