...
class TestPropertyJsonFormat:
    ...
    def setup_test_data(self, manager):
        ...
        manager.set_item_property("testlist", "scene_01", "image_downloaded", "completed")
        manager.set_item_property("testlist", "scene_01", "image_generated", "completed")
        manager.set_item_property("testlist", "scene_01", "thread_id", "test-thread-123")
        
        # Add properties to item_0001
        manager.set_item_property("testlist", "item_0001", "image_downloaded", "pending")
        manager.set_item_property("testlist", "item_0001", "thread_id", "test-thread-456")
        
        # Add properties to item_0002
        manager.set_item_property("testlist", "item_0002", "image_downloaded", "completed")
    ...
    def test_json_format_grouped_by_item(self, manager, setup_test_data):
        ...
        result = runner.invoke(item_property_list, [
            "testlist"
        ], obj={"db_path": manager.db.db_path}, env=env)
    ...
    def test_yaml_xml_formats_use_original_structure(self, manager, setup_test_data):
        ...
        # Test YAML format
        result_yaml = runner.invoke(item_property_list, [
            "testlist"
        ], obj={"db_path": manager.db.db_path}, env={"TODOIT_OUTPUT_FORMAT": "yaml"})
        ...
        # Test XML format
        result_xml = runner.invoke(item_property_list, [
            "testlist"
        ], obj={"db_path": manager.db.db_path}, env={"TODOIT_OUTPUT_FORMAT": "xml"})
