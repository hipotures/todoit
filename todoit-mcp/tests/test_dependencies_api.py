...
class TestDependenciesAPI:
    ...
    def test_remove_item_dependency(self, manager, sample_lists):
        ...
        # Remove dependency
        result = manager.remove_item_dependency("frontend", "item_1", "backend", "item_1")
        assert result == True
    ...
    def test_dependency_types(self, manager, sample_lists):
        ...
        manager.add_item_dependency(
            "frontend", "item_2", "backend", "item_2",
    ...
    def test_complex_dependency_chain(self, manager, sample_lists):
        ...
        # Create third list
        manager.create_list("deployment", "Deployment Tasks", ["Deploy staging", "Deploy prod"])
